export type command_type =
  ...
  | { type: "change_user_name"; data: { new_name: string } }
...
export function parse_command_type(x: any): command_type {
  switch (x.type) {
    ...
    case "change_user_name":
      return { type: "change_user_name", data: parse_2(x.data) };
    case "change_email":
      return { type: "change_email", data: parse_3(x.data) };
    case "ping":
      return { type: "ping", data: parse_4(x.data) };
    case "create_board":
      return { type: "create_board", data: parse_5(x.data) };
    case "rename_board":
      return { type: "rename_board", data: parse_5(x.data) };
    default:
      throw new Error("not a command_type:" + x);
  }
}
